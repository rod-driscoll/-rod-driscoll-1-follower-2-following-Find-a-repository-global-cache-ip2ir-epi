...
{
    /// <summary>
    /// IRSetTopBoxBase replacing IrOutputPortController with IIrOutputPortController to enable using brand agnostic IrPorts
    /// </summary>
    [Description("Wrapper class for an IR Set Top Box")]
    public class IRSetTopBoxBaseAdvanced : EssentialsBridgeableDevice, IHasIrOutputPortController, ISetTopBoxControls, IRoutingOutputs, IUsageTracking, IHasPowerControl, ITvPresetsProvider
    {
        public IIrOutputPortController IrPort { get; private set; }
        ...
        public IRSetTopBoxBaseAdvanced(string key, string name, IIrOutputPortController portCont,
            ...
            : base(key, name)
        {
            ...
            Debug.Console(1, this, "IRSetTopBoxBaseAdvanced constructor complete, key: {0}", key);
        }
